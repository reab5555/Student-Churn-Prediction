...
Here we can see for example the distribution of each of the top features. furthermore, we can see that Gender and Age at enrollment are negatively correlated with Graduation (Target), while all other features are positively correlated.  
